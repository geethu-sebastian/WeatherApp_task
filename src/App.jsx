 ...
 const searchLocation = (event) => {
  ...
  return (
    <div className="flex w-screen h-screen bg-white items-center justify-center">
      <div className="flex flex-col w-[80%] md:h-[80%] bg-blue-200 rounded-xl items-center py-4">
        ...
        <input
          ...
          />
          <div className="flex flex-col w-full h-[70%] items-center justify-center py-6">
          ...
          {data.name !== undefined &&
          <div className="flex flex-row w-[90%] justify-between items-center py-4">
